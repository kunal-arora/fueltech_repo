 ...
 */
class Meigee_ThemeOptionsMinimalism_Block_Html_Topmenu extends Mage_Page_Block_Html_Topmenu
{
    ...
    {
        $menuContent = MAGE::helper('ThemeOptionsMinimalism')->getThemeOptionsMinimalism('menu');
        $html = '';
        ...
        $navigation = MAGE::helper('ThemeOptionsMinimalism')->getThemeOptionsMinimalism('menu');
        ...
        foreach ($children as $child) {
            ...
            if ($child->hasChildren()) {
                ...
                if ($navigation['type'] == 'menu_wide' && $menuContent['additional'] ) {
                    ...
                    if(Mage::helper('ThemeOptionsMinimalism')->isActive('identifier', $child->getId()) && $childLevel == 0) {
