 ...
 *
 */
class Meigee_ThemeOptionsMinimalism_Model_Activation extends Mage_Core_Model_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsMinimalism/etc/import/cms.xml';
