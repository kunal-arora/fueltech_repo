 ...
 *
 */
class Meigee_ThemeOptionsMinimalism_Helper_Menu extends Mage_Core_Helper_Abstract
{
 
	public function getMenuStaticBlocks () {

		$staticList = Mage::getStoreConfig('meigee_minimalism_general/menu/menu_static');
