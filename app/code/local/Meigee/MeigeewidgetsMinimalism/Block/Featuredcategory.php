 ...
 *
 */
class Meigee_MeigeewidgetsMinimalism_Block_Featuredcategory
...
implements Mage_Widget_Block_Interface
{
	...
	public function sliderGridSelection_2() {
    ...
    public function getSliderOptions () {
        ...
        if ($this->getData('template') == 'meigee/meigeewidgetsminimalism/slider.phtml' and $this->getData('autoSlide') == 1) {
            $options =
            ', autoSlide: 1, '
	...
	public function getSliderOptions_2 () {
        
        if ($this->getData('template') == 'meigee/meigeewidgetsminimalism/slider_2.phtml' and $this->getData('autoSlide_2') == 1) {
            $options =
            ', autoSlide: 1, '
	...
	public function getWidgetId_2 () {
        return $this->getData("widget_id_2");
    }
}